        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                <ul class="navbar-nav main-nav-links mx-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="../../iniciativas.php">Nosotros</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="search-bar-container">
                    <form class="d-flex">
                        <input class="form-control search-bar" type="search" placeholder="Buscar en Roots..."
                            aria-label="Buscar">
                    </form>
                </div>

                <div class="header-actions d-flex align-items-center ms-lg-3">
                    <a href="../../login.php" class="text-decoration-none"><button
                            class="btn btn-login">Log-in</button></a>
                    <a href="../../front/cliente/perfil.php"><i
                            class="fas fa-user header-icon d-none d-lg-inline-flex"></i></a>
                    <a href="../../producto.php"><i
                            class="fas fa-shopping-cart header-icon d-none d-lg-inline-flex"></i></a>
                </div>
            </div>
        </div>
    </nav>
