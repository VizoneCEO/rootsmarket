...
<head>
    ...
    <style>
        ...
        .text-green {
            color: #2d4c48;
            /* El tono de verde que ya hemos estado utilizando */
        }


        .text-green {
            color: #2d4c48;
            /* Tono verde que estamos usando */
        }
        ...
        .text-green {
            color: #2d4c48;
            /* Tono de verde usado en el resto del proyecto */
        }
        ...
        .text-green {
            color: #2d4c48;
            /* Verde utilizado en el proyecto */
        }
